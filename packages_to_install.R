...
install.pakcages('colorRampPalette')
...
install.packages('qcc')# Quality Control Charts: an R package for quality control charting and statistical process control.
#END OF LIST
